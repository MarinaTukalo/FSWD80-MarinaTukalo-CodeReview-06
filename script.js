...
var Location = /** @class */ (function () {
    ...
    Location.prototype.display = function () {
        return "\n\t\t\t\t<img class=\"img-fluid card-img-top d-none d-sm-block\" src=\"img/" + this.img + "\">\n\t\t\t\t" + this.place + "<br><hr>\n\t\t\t\t" + this.zip + "<br><hr>  \n\t\t\t\t" + this.address + " \n\t\t\t";
    };
    return Location;
}());
...
var Thai_V = new Food("vienna_3.jpg", "LEMON LEAF THAI RESTAURANT", "1050 Vienna", "Kettenbrückengasse 19", 5812308, "Thai", "www.lemonleaf.at");
var Sixta_V = new Food("vienna_4.jpg", "SIXTA RESTAURANT", "1050 Vienna", "Schönbrunner Straße 21", 5852856, "traditional austrian", "www.sixta-restaurant.at");
...
var Greek_S = new Food("sydney_3.jpg", "The RESTAURANT ALPHA", "2000 Sydney", "238 Castlereagh St", 90981111, "greek", "www.alpharestaurant.com.au");
var Italian_S = new Food("sydney_4.jpg", "The RESTAURANT PENDOLINO", "2000 Sydney", "100/412-414 George Street LEVEL 2 THE STRAND ARCADE", 92316117, "italian", "www.pendolino.com.au");
